import { initializeApp } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";
        ...
        document.getElementById('btn-open-settings').addEventListener('click', () => {
            document.getElementById('menu-account-dropdown').classList.add('hidden'); // 关掉下拉菜单
        ...
        function switchTab(tabName) {
            ...
            announce(`已切换到 ${document.getElementById(`tab-btn-${tabName}`).textContent}`);
        }
        ...
        document.getElementById('tab-btn-location').addEventListener('click', () => switchTab('location'));